    ...
    <>
      <section id="contact" className="p-8">
        ...
        <p className="text-lg text-gray-700 mb-6">
          Ready to take the next step? Contact us today and let&apos;s discuss how we can help grow your business.
        </p>
        ...
        <div className="flex gap-4 mb-6">
          ...
          >
            <a href="mailto:fatmatag60@gmail.com">Email Us</a>
          </Button>
          <Button
            asChild
            className="bg-green-600 hover:bg-green-700 text-white"
          >
            <a href="tel:+201090290562">Call Us</a>
          </Button>
        </div>
